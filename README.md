...
### 2. Install the CSI Drivver

1. On a machine that has Helm and kubectl present, download and untar the helm chart.
1. Ensure you have the relevant outputs from the RESET service installation. They are used for the chart install as follows:
    ...
    | `.controller.caCert`     | Conditional | Required if self-signed cert was created by service installer      |
