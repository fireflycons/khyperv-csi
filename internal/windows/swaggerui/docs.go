// Package swaggerui Code generated by swaggo/swag. DO NOT EDIT
package swaggerui
...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "rest.ListVolumesResponse": {
            ...
            "properties": {
                "next_token": {
                    "description": "If there are more entries in the list, this token can be used to fetch the next set of entries.",
                    "type": "string"
                },
                "volumes": {
